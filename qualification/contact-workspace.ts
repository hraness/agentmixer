...
/** Synthetic contact workspace for native qualification fixtures: a vendored
 * copy of the consumer's confined file boundary, so the fixture owns the exact
 * filesystem contract it exercises without depending on a consumer package. Its
 * file digest is recorded in fixture receipts as contactWorkspace.
